...
## openni_wrapper (indigo) - 0.0.11-0

The packages in the `openni_wrapper` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo openni_wrapper` on `Fri, 22 May 2015 14:27:37 -0000`
...
- rosdistro version: `0.0.10-5`
- old version: `0.0.10-5`
- new version: `0.0.11-0`
...
## openni_wrapper (indigo) - 0.0.10-5

The packages in the `openni_wrapper` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo openni_wrapper` on `Thu, 26 Mar 2015 14:23:43 -0000`
...
- old version: `0.0.10-4`
- new version: `0.0.10-5`
...
## openni_wrapper (indigo) - 0.0.10-4

The packages in the `openni_wrapper` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo openni_wrapper` on `Thu, 26 Mar 2015 14:22:14 -0000`
...
## openni_wrapper (indigo) - 0.0.10-3

The packages in the `openni_wrapper` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo openni_wrapper` on `Thu, 26 Mar 2015 14:20:44 -0000`
...
## openni_wrapper (indigo) - 0.0.10-2

The packages in the `openni_wrapper` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo openni_wrapper` on `Thu, 26 Mar 2015 14:19:13 -0000`
...
## openni_wrapper (indigo) - 0.0.10-1

The packages in the `openni_wrapper` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --non-interactive -t indigo -r indigo openni_wrapper` on `Thu, 26 Mar 2015 14:17:48 -0000`
...
## openni_wrapper (indigo) - 0.0.10-0
